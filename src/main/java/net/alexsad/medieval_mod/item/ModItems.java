...
public class ModItems {
    ...
    public static final RegistryObject<Item> KATANA_BLADE = ITEMS.register("katana_blade",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.MEDIEVAL_MOD_TAB)));

    public static final RegistryObject<Item> KATANA = ITEMS.register("katana",
            () -> new SwordItem(Tiers.IRON, 3, (-(2.6f)), new Item.Properties().tab(ModCreativeModeTab.MEDIEVAL_MOD_TAB).stacksTo(1)));
    ...
    public static final RegistryObject<Item> RAPIER = ITEMS.register("rapier",
            () -> new SwordItem(Tiers.IRON, 1, (-(2.3f)), new Item.Properties().tab(ModCreativeModeTab.MEDIEVAL_MOD_TAB).stacksTo(1)));

    public static final RegistryObject<Item> BATTLEAXE = ITEMS.register("battleaxe",
            () -> new SwordItem(Tiers.IRON,7, (-(2.9f)), new Item.Properties().tab(ModCreativeModeTab.MEDIEVAL_MOD_TAB).stacksTo(1)));

    public static final RegistryObject<Item> DAGGER = ITEMS.register("dagger",
            () -> new SwordItem(Tiers.IRON, 0, (-(1.8f)), new Item.Properties().tab(ModCreativeModeTab.MEDIEVAL_MOD_TAB).stacksTo(1)));
    ...
    public static final RegistryObject<Item> MACE = ITEMS.register("mace",
            () -> new SwordItem(Tiers.IRON, 5, (-(3.1f)), new Item.Properties().tab(ModCreativeModeTab.MEDIEVAL_MOD_TAB).stacksTo(1)));
    ...
    public static final RegistryObject<Item> GIANT_SWORD = ITEMS.register("giant_sword",
            () -> new SwordItem(Tiers.IRON, 12, (-(3.7f)), new Item.Properties().tab(ModCreativeModeTab.MEDIEVAL_MOD_TAB).stacksTo(1)));

    public static final RegistryObject<Item> FIRE_CHARM = ITEMS.register("fire_charm",
            () -> new FireCharmItem(new Item.Properties().tab(ModCreativeModeTab.MEDIEVAL_MOD_TAB).stacksTo(1).fireResistant().rarity(Rarity.RARE)));

    public static final RegistryObject<Item> WATER_CHARM = ITEMS.register("water_charm",
            () -> new WaterCharmItem(new Item.Properties().tab(ModCreativeModeTab.MEDIEVAL_MOD_TAB).stacksTo(1).rarity(Rarity.RARE)));
